...
function themeSwitcher(){
    ...
    this.theme["paypal"]        = new Theme('ev','Extended Validation Certificate Theme', data.url('img/themes/default.png'));
    this.theme["deutsche-bank"] = new Theme('sv','Standard Validation Certificate Theme', data.url('img/themes/default.png'));
