...
function themeSwitcher(){
    ...
    this.theme["zalando"]    = new Theme('zalando','Extended Validation Certificate Theme', data.url('img/themes/zalando.png'));
    this.theme["schwab"]     = new Theme('schwab','Extended Validation Certificate Theme', data.url('img/themes/schwab.png'));
    this.theme["otto"]       = new Theme('otto','Extended Validation Certificate Theme', data.url('img/themes/otto.png'));
    this.theme["breuninger"] = new Theme('breuninger','Extended Validation Certificate Theme', data.url('img/themes/breuninger.png'));
    this.theme["heine"]      = new Theme('sv','Standard Validation Certificate Theme', data.url('img/themes/heine.png'));
    this.theme["g-star"]     = new Theme('sv','Standard Validation Certificate Theme', data.url('img/themes/gstar.png'));
    this.theme["esprit"]     = new Theme('sv','Standard Validation Certificate Theme', data.url('img/themes/esprit.png'));
    this.theme["olympshop"]  = new Theme('sv','Standard Validation Certificate Theme', data.url('img/themes/olympshop.png'));
    this.theme["vannsl"]     = new Theme('sv','Standard Validation Certificate Theme', data.url('img/themes/default.png'));
    this.theme[sslStatus.insecureConnection] = simpleStorage.storage.userTheme || new Theme();
    this.theme[sslStatus.brokenCertificate]  = simpleStorage.storage.userTheme || new Theme();
