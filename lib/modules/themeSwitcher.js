...
function themeSwitcher(){
    ...
    // TODO: set in the correct pages with corresponding images
    this.theme["paypal"]        = new Theme('ev','Extended Validation Certificate Theme', data.url('img/themes/extendedValidation.png'));
    this.theme["deutsche-bank"] = new Theme('sv','Standard Validation Certificate Theme', data.url('img/themes/standardValidation.png'));
