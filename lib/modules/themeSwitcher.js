...
function themeSwitcher(){
    ...
    this.theme["zalando"]    = new Theme('ev','Extended Validation Certificate Theme', data.url('img/themes/zalando.png'));
    this.theme["schwab"]     = new Theme('ev','Extended Validation Certificate Theme', data.url('img/themes/schwab.png'));
    this.theme["otto"]       = new Theme('ev','Extended Validation Certificate Theme', data.url('img/themes/otto.png'));
    this.theme["breuninger"] = new Theme('ev','Extended Validation Certificate Theme', data.url('img/themes/breuninger.png'));
